                    ...
                    <div class="media">
                        <div class="d-flex flex-column vote-controls">
                            <a title="This question is useful" 
                               ...
                               onclick="event.preventDefault(); document.querySelector('#up-vote-question-{{ $question->id }}').submit();">
                            ...
                            <a title="This question is not useful" 
                               ...
                               onclick="event.preventDefault(); document.querySelector('#down-vote-question-{{ $question->id }}').submit();">
                            ...
                            <a title="Click to mark as favorite question (Click again to undo)" 
                               ...
                               onclick="event.preventDefault(); document.querySelector('#favorite-question-{{ $question->id }}').submit();">
